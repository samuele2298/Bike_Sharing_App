...
class Battery {
  ...
  // Getter per nfcCode
  String get nfcCode => _nfcCode;

  // Setter per nfcCode
  set nfcCode(String value) {
    _nfcCode = value;
  }

  // Getter per macAddress
  String get macAddress => _macAddress;

  // Setter per macAddress
  set macAddress(String value) {
    _macAddress = value;
  }

  // Getter per batteryCode
  String get batteryCode => _batteryCode;

  // Setter per batteryCode
  set batteryCode(String value) {
    _batteryCode = value;
  }
}
